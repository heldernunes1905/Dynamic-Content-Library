...
<table class="table xxx">
    ...
    <tbody id="myTable">
        ...
        foreach ($studio as $stu) { ?>
            <tr >
                    <td><a href='<?=base_url()?>index.php/studio/<?= $stu->studio_id?>'><?php echo $stu->first_name;?></a></td>
                    <td><a href='<?=base_url()?>index.php/studio/<?= $stu->studio_id?>'><?php echo $stu->last_name; ?></a></td>
