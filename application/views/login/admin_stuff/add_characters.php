...
<div class="container-fluid no-padding">
    <div id="my-row" class="row">
      ...
      <div id="main">
        <div id="login">
            <h2 style="color:white;">Create Characters Form</h2>
    ...
    echo form_open('add_characters_db');
    ?>
            <hr />
    ...
    <div class="col-sm-3"  >
        ...
        <div class="col-sm-8"  >
            <?php             echo '<input  type="text" name="first_name" id="first_name"/>';
 ?>
    ...
    <div class="col-sm-3"  >
        ...
        <div class="col-sm-8"  >
            <?php             echo '<input type="text" name="last_name" id="last_name"/>';
 ?>
    </div>
    </div>
    </div>
